...
import Icon from 'react-native-vector-icons/FontAwesome5'; // Import the Icon component from react-native-vector-icons
...
const BottomStack = () => (
  <Tab.Navigator>
    ...
    <Tab.Screen
      ...
      options={{
        tabBarIcon: ({color, size}) => (
          <Icon name="weight" color={color} size={size} />
        ),
      }}
    />
  </Tab.Navigator>
